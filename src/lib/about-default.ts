...
export const DEFAULT_SEO_SETTINGS: SeoSettingsRecord = {
  titleTemplate: "%s | Elang Dimas Syadewa",
  defaultTitle: "Elang Dimas Syadewa | Cybersecurity Portfolio, CTF Writeups & Projects",
  description: "Official portfolio of Elang Dimas Syadewa, cybersecurity enthusiast, CTF player, and web developer. Explore CTF writeups, projects, achievements, and contact information.",
  canonicalUrl: "https://claritys.my.id",
  previewImageUrl: "",
  siteName: "Elang Dimas Syadewa Portfolio",
  locale: "id_ID",
  keywords: [
    "Elang Dimas Syadewa",
    "Elang Dimas Syadewa Claritys",
    "Elang Dimas Syadewa portfolio",
    "Claritys",
    "claritys11",
    "Elang Dimas Syadewa cybersecurity",
    "Elang Dimas Syadewa CTF",
...
export function getDefaultProfileSettings(): ProfileSettingsRecord {
  return {
    ...
    websiteUrl: "https://claritys.my.id",
