...
const PRIMARY_SITE_BASE_URL = 'https://clarityz.my.id';
const PRIMARY_SITE_HOST = 'clarityz.my.id';
const LEGACY_SITE_HOSTS = new Set(['claritys.my.id', 'portf.claritys.my.id']);
